-- Just a question bro who wants to skid a gui libary fr :skull:
...
local themes = {
	index = {'Dark', 'Amethyst', 'Purple', 'Blue'}, 
	Amethyst = {
	...
	Purple = {
		['Shadow'] = Color3.fromRGB(20, 12, 28),
		['Background'] = Color3.fromRGB(26, 16, 36),
		['Page'] = Color3.fromRGB(22, 14, 32),
		['Main'] = Color3.fromRGB(168, 85, 247),
		['Text & Icon'] = Color3.fromRGB(245, 240, 255),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(32, 20, 44),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(88, 44, 132),
					['Toggle Value'] = Color3.fromRGB(168, 85, 247),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(40, 26, 56),
					['Toggle Value'] = Color3.fromRGB(70, 46, 96),
				}
			},
			['Label'] = { ['Background'] = Color3.fromRGB(32, 20, 44) },
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(32, 20, 44),
				['Value Background'] = Color3.fromRGB(22, 14, 32),
				['Value Stroke'] = Color3.fromRGB(245, 240, 255),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(22, 14, 32),
					['Search'] = Color3.fromRGB(42, 26, 58),
					['Item Background'] = Color3.fromRGB(52, 32, 72),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(32, 20, 44),
				['Value Background'] = Color3.fromRGB(22, 14, 32),
				['Value Stroke'] = Color3.fromRGB(245, 240, 255),
				['Slider Bar'] = Color3.fromRGB(88, 44, 132),
				['Slider Bar Value'] = Color3.fromRGB(168, 85, 247),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 20, 44)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 20, 44))
				},
				['Background Code'] = Color3.fromRGB(60, 36, 84),
				['Background Code Value'] = Color3.fromRGB(46, 28, 64),
				['ScrollingFrame Code'] = Color3.fromRGB(200, 160, 255)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(32, 20, 44),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(22, 14, 32),
					['UIStroke'] = Color3.fromRGB(245, 240, 255),
				}
			}
		}
	},
	Blue = {
		['Shadow'] = Color3.fromRGB(15, 20, 35),
		['Background'] = Color3.fromRGB(20, 30, 50),
		['Page'] = Color3.fromRGB(18, 28, 48),
		['Main'] = Color3.fromRGB(0, 120, 255),
		['Text & Icon'] = Color3.fromRGB(245, 245, 245),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(22, 32, 52),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(0, 100, 220),
					['Toggle Value'] = Color3.fromRGB(0, 120, 255),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(15, 25, 45),
					['Toggle Value'] = Color3.fromRGB(0, 60, 150),
				}
			},
			['Label'] = { ['Background'] = Color3.fromRGB(22, 32, 52) },
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(22, 32, 52),
				['Value Background'] = Color3.fromRGB(18, 28, 48),
				['Value Stroke'] = Color3.fromRGB(245, 245, 245),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(18, 28, 48),
					['Search'] = Color3.fromRGB(25, 35, 55),
					['Item Background'] = Color3.fromRGB(28, 40, 60),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(22, 32, 52),
				['Value Background'] = Color3.fromRGB(18, 28, 48),
				['Value Stroke'] = Color3.fromRGB(245, 245, 245),
				['Slider Bar'] = Color3.fromRGB(0, 100, 220),
				['Slider Bar Value'] = Color3.fromRGB(0, 120, 255),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(22, 32, 52)), ColorSequenceKeypoint.new(1, Color3.fromRGB(22, 32, 52))},
				['Background Code'] = Color3.fromRGB(35, 50, 70),
				['Background Code Value'] = Color3.fromRGB(28, 45, 65),
				['ScrollingFrame Code'] = Color3.fromRGB(100, 180, 255)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(22, 32, 52),
